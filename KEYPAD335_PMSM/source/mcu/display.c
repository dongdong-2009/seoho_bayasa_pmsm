...
#define MODE_2d_2u_kRPM 66
#define MODE_2d_2u_s 67
#define MODE_1d_3u_us 68
#define MODE_3d_1u_kRPM 69
#define MODE_3d_1u_VkRPM 70
#define MODE_3d_1u_uH 71
#define MODE_1d_3u_mA_V 72
#define MODE_2d_2u_V 73
#define MODE_2d_2u_mA 74
#define MODE_1d_3u_VkRPM 70
...
void SYS_ParameterDisplay(unsigned char mode)
{
	...
	else if(mode == MODE_3d_1u_s)
	{
        ...
        else if(mode == MODE_2d_2u_s)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     %02d.%02u s     ",(int)Temporary/100,Temporary%100));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     %02d.%02u s     ",(int)edit_Temp/100,edit_Temp%100));
			SYS_cursor_ON_Mode(CURSOR_MODE_9);
		}
	}
        else if(mode == MODE_2d_2u_V)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 2d.%02u V     ",(int)Temporary/100,Temporary%100));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 2d.%02u V     ",(int)edit_Temp/100,edit_Temp%100));
			SYS_cursor_ON_Mode(CURSOR_MODE_9);
		}
	}               
        else if(mode == MODE_2d_2u_mA)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("    % 2d.%02u mA     ",(int)Temporary/100,Temporary%100));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("    % 2d.%02u mA     ",(int)edit_Temp/100,edit_Temp%100));
			SYS_cursor_ON_Mode(CURSOR_MODE_9);
		}
	}  
	...
	else if(mode == MODE_25)
	{
		if(!Edit_flag)
		{
			if(Temporary == 0)		 CLCD_string(0xC0,"[0] STOP        ");
                        ...
                        else if(Temporary == 4)CLCD_string(0xC0,"[4] SPEED_Down  ");
			//else CLCD_string(0xC0,(char*)_TEXT("irValue: %d     ",Temporary));
                        else Temporary = 0;
			CLCD_cursor_OFF();
		}
	...
	else if(mode == MODE_1d_3u_mA_V)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 1d.%03u  mA,V ",(int)Temporary/1000,Temporary%1000));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 1d.%03u  mA,V ",(int)edit_Temp/1000,edit_Temp%1000));
			SYS_cursor_ON_Mode(CURSOR_MODE_7);
		}
          

	}
	else if(mode == MODE_1d_3u_VkRPM)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 1d.%03u  VkRPM",(int)Temporary/1000,Temporary%1000));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 1d.%03u  VkRPM",(int)edit_Temp/1000,edit_Temp%1000));
			SYS_cursor_ON_Mode(CURSOR_MODE_7);
		}
	...
	else if(mode == MODE_P8_1to29_selection)
	{
		if(!Edit_flag)
		{
			...
			else if(Temporary == 1)CLCD_string(0xC0,"[1] Drive Enable");
			...
			else if(Temporary == 8)CLCD_string(0xC0,"[8] AI_REF_Act  ");
			...
			else if(Temporary ==13)CLCD_string(0xC0,"[13] MB Brk St  ");
			else if(Temporary ==14)CLCD_string(0xC0,"[14] Accel/Decel");
			else if(Temporary ==15)CLCD_string(0xC0,"[15] Ref INC    ");
			else if(Temporary ==16)CLCD_string(0xC0,"[16] Ref DEC    ");
			else if(Temporary ==17)CLCD_string(0xC0,"[17] Acc/Dec Byp");
			else if(Temporary ==18)CLCD_string(0xC0,"[18] PID ENABLE ");
		...
		else
		{
			...
			else if(edit_Temp == 1)CLCD_string(0xC0,"[1] Drive Enable");
			...
			else if(edit_Temp == 8)CLCD_string(0xC0,"[8] AI_REF_Act  ");
			...
			else if(edit_Temp ==13)CLCD_string(0xC0,"[13] MB Brk St  ");
			else if(edit_Temp ==14)CLCD_string(0xC0,"[14] Accel/Decel");
			else if(edit_Temp ==15)CLCD_string(0xC0,"[15] Ref INC    ");
			else if(edit_Temp ==16)CLCD_string(0xC0,"[16] Ref DEC    ");
			else if(edit_Temp ==17)CLCD_string(0xC0,"[17] Acc/Dec Byp");
			else if(edit_Temp ==18)CLCD_string(0xC0,"[18] PID ENABLE ");
	...
	else if(mode == MODE_43)
	{
		if(!Edit_flag)
		{
			...
			else if(Temporary == 2)CLCD_string(0xC0,"[2]Out   Current");
		...
		else
		{
			...
			else if(edit_Temp == 2)CLCD_string(0xC0,"[2]Out   Current");
	...
	else if(mode == MODE_3d_1u_kRPM)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 3d.% 1u kRPM ",(int)Temporary/10,Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 3d.% 1u kRPM ",(int)edit_Temp/10,edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	} 
	else if(mode == MODE_3d_1u_VkRPM)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("    % 3d.% 1u V/kRPM",(int)Temporary/10,Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("    % 3d.% 1u V/kRPM",(int)edit_Temp/10,edit_Temp%10));
			SYS_cursor_ON_Mode(CURSOR_MODE_6);
		}
	}          
	else if(mode == MODE_3d_1u_uH)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("    % 3d.% 1u   uH  ",(int)Temporary/10,Temporary%10));
			CLCD_cursor_OFF();
		}
		else
		{
	...
	else if(mode == MODE_1d_3u_us)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 1d.%03u   us ",(int)Temporary/1000,(int)Temporary%1000));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 1d.%03u   us ",(int)edit_Temp/1000,(int)edit_Temp%1000));
			SYS_cursor_ON_Mode(CURSOR_MODE_7);
		}
	}
	...
	else if(mode == MODE_2d_2u_kRPM)
	{
		if(!Edit_flag)
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 2d.%02u  kRPM ",(int)Temporary/100,Temporary%100));
			CLCD_cursor_OFF();
		}
		else
		{
			CLCD_string(0xC0,(char*)_TEXT("     % 2d.%02u  kRPM ",(int)edit_Temp/100,edit_Temp%100));
			SYS_cursor_ON_Mode(CURSOR_MODE_9);
		}
	}
}
	...
	else if(mode==EDIT_MODE_P8_123456)//selset
	{
		...
		else if(KeyState.KeyValue == UP)
		{
			if(e_temp == 0) e_temp = 1;
                        ...
                        else if(e_temp == 7) e_temp = 8;
                        else if(e_temp == 8) e_temp = 9;
                        else if(e_temp == 9) e_temp = 10;
                        else if(e_temp == 10) e_temp = 11;
                        else if(e_temp == 11) e_temp = 13;
                        else if(e_temp == 13) e_temp = 14;
                        else if(e_temp == 14) e_temp = 15;
                        else if(e_temp == 15) e_temp = 16;
                        else if(e_temp == 16) e_temp = 17;
                        else if(e_temp == 17) e_temp = 18;
                        else if(e_temp == 18) e_temp = 19;
                        else if(e_temp == 19) e_temp = 20;
                        else if(e_temp == 20) e_temp = 21;
                        else if(e_temp == 21) e_temp = 22;
                        else if(e_temp == 22) e_temp = 23;
                        else if(e_temp == 23) e_temp = 24;
                        else if(e_temp == 24) e_temp = 25;
                        else if(e_temp == 25) e_temp = 26;
                        else if(e_temp == 26) e_temp = 27;
                        else if(e_temp == 27) e_temp = 29;
                        else if(e_temp == 29) e_temp = 0;
			else e_temp = 0;
		...
		else if(KeyState.KeyValue == DN)
		{
			if(e_temp == 0) e_temp = 29;
                        ...
                        else if(e_temp == 8) e_temp = 7;
                        else if(e_temp == 9) e_temp = 8;
                        else if(e_temp == 10) e_temp = 9;
                        else if(e_temp == 11) e_temp = 10;
                        else if(e_temp == 13) e_temp = 11;
                        else if(e_temp == 14) e_temp = 13;
                        else if(e_temp == 15) e_temp = 14;
                        else if(e_temp == 16) e_temp = 15;
                        else if(e_temp == 17) e_temp = 16;
                        else if(e_temp == 18) e_temp = 17;
                        else if(e_temp == 19) e_temp = 18;
                        else if(e_temp == 20) e_temp = 19;
                        else if(e_temp == 21) e_temp = 20;
                        else if(e_temp == 22) e_temp = 21;
                        else if(e_temp == 23) e_temp = 22;
                        else if(e_temp == 24) e_temp = 23;
                        else if(e_temp == 25) e_temp = 24;
                        else if(e_temp == 26) e_temp = 25;
                        else if(e_temp == 27) e_temp = 26;
                        else if(e_temp == 29) e_temp = 27;
...
void SYS_cursor_ON_Mode(unsigned char mode)
{
	...
	else if(mode==CURSOR_MODE_9)// _ _ . _ _
	{
		if(5<posInpage)posInpage=5;
...
void SYS_1_0_00(void)
{
	...
	if(RefreshFlag)
	{
		...
		//CLCD_string(0xC0,(char*)_TEXT("      % 5d rpm ", ReadDataMem(2310)));
                CLCD_string(0xC0,(char*)_TEXT("      % 2d.% 2u kRPM",(int)DATA_Registers[2310]/100,DATA_Registers[2310]%100));
	}
}
...
void SYS_2_00(void)
{
	...
	else if(KeyState.KeyValue == ENTER)MenuDisplay = SYS_2_00_04;
...
void SYS_2_21(void)
{
	...
	else if(KeyState.KeyValue == ENTER)MenuDisplay = SYS_2_21_10;
...
void SYS_2_00_06(void)
{
	...
	if(RefreshFlag)
	{
		...
		CLCD_string(0x80,(char*)_cpy_flash2memory(&PAGE_DIR_2_00_XX[6][0]));
		SYS_ParameterDisplay(MODE_5u);
	}
}
...
void SYS_2_05_09(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_2d_2u_s);
	}
}
...
void SYS_2_06_05(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_1d_3u_mA_V);
	}
}
void SYS_2_06_06(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_2d_2u_V);
	}
}
...
void SYS_2_06_10(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_2d_2u_mA);
	}
}
...
void SYS_2_21_10(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_3d_1u_uH);
	}
}
...
void SYS_2_21_12(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_1d_3u_VkRPM);
	}
}
...
void SYS_2_21_15(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_3d_1u_kRPM);
	}
}
...
void SYS_2_23_00(void)
{
	...
	if(RefreshFlag)
	{
		...
		SYS_ParameterDisplay(MODE_1d_3u_us);
	}
}
